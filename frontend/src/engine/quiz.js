...
export const QUESTIONS = [
...

  {
    ...
    answers: [
      ...
      },
      {
        ...
        sub: '594 000 — 1 080 000 DH — je m\'assume',
      ...
      },
      {
        ...
        sub: 'Plus de 1 080 000 DH — le prix n\'est plus un critère',
  ...
  // ════════════════════════════════════════════════════════════════════════════
  // BLOC 6 — FIABILITÉ, TECH & CONFORT RECHERCHÉS (21 questions)
  // ════════════════════════════════════════════════════════════════════════════
...
export function createSession(cars) {
...
export function getBestQuestion(session, cars) {
...
export function applyAnswer(session, question, answerIndex, cars) {
...
export function getTopCars(session, cars, n = 3) {
  return cars
...
export function formatQuestion(q, number) {
  if (!q) return null;
  return {
    id: q.id,
    question: q.question,
...
export function getMatchReason(car) {
  const pools = {
    eco: [
