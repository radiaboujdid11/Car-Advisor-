...
function Intro({ onStart }) {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 600, height: 600, background: 'radial-gradient(ellipse at center, rgba(245,237,216,.08) 0%, transparent 70%)', pointerEvents: 'none' }} />

      <div style={{ textAlign: 'center', maxWidth: '480px', position: 'relative' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '.5rem', background: 'rgba(245,237,216,.14)', border: '1px solid rgba(245,237,216,.3)', color: 'var(--gold)', fontSize: '.75rem', letterSpacing: '.12em', textTransform: 'uppercase', padding: '.4rem 1rem', borderRadius: '50px', marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1px', background: 'rgba(245,237,216,.12)', border: '1px solid rgba(245,237,216,.12)', borderRadius: '12px', overflow: 'hidden', marginBottom: '2.5rem' }}>
        ...
        {topProbs.map((car, i) => {
          ...
          return (
            <div key={`${car.make}-${car.model}`}>
              ...
              <div style={{ height: '2px', background: 'rgba(245,237,216,.06)', borderRadius: '2px', overflow: 'hidden' }}>
                <div style={{ height: '100%', width: `${barWidth}%`, background: i === 0 ? 'var(--gold)' : 'rgba(245,237,216,.3)', borderRadius: '2px', transition: 'width .9s cubic-bezier(.4,0,.2,1)' }} />
              </div>
            </div>
          );
        })}
    ...
    <div style={{ minHeight: '100vh', background: '#6B001A', display: 'flex', flexDirection: 'column', position: 'relative' }}>
      ...
      <div style={{ position: 'sticky', top: 0, zIndex: 10, borderBottom: '1px solid rgba(245,237,216,.15)', background: 'rgba(128,0,32,.95)', backdropFilter: 'blur(16px)', padding: '.875rem 1.5rem' }}>
        <div style={{ maxWidth: '640px', margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
            ...
            <span style={{ fontSize: '.72rem', letterSpacing: '.18em', textTransform: 'uppercase', color: 'rgba(245,237,216,.55)' }}>
              {confidence > 0
          ...
          <div style={{ height: '3px', background: 'rgba(245,237,216,.1)', borderRadius: '3px', overflow: 'hidden' }}>
          ...
          {leadingCar && confidence > 15 && (
            <p style={{ fontSize: '.72rem', letterSpacing: '.15em', textTransform: 'uppercase', color: 'rgba(245,237,216,.45)', marginTop: '8px' }}>
              En tête :{' '}
      ...
      <div className="quiz-q-wrap" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem 1.5rem' }}>
        <div style={{ width: '100%', maxWidth: '640px', opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(18px)', transition: 'opacity .3s ease, transform .3s ease' }}>
          ...
          <p style={{ textAlign: 'center', fontSize: '.72rem', letterSpacing: '.18em', textTransform: 'uppercase', color: 'rgba(245,237,216,.35)', marginTop: '2.5rem' }}>
