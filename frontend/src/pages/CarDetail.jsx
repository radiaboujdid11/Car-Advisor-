  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        {/* Specs grid */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '1px', background: 'var(--line)', marginBottom: '4rem', borderRadius: '12px', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '5rem' }}>
          <button
            ...
            style={{
              ...
              borderRadius: '50px', transition: 'opacity 0.2s',
            }}
          >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '50px', transition: 'border-color 0.2s, background 0.2s',
            }}
        ...
        {similar.length > 0 && (
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '1px', background: 'var(--line)', borderRadius: '12px', overflow: 'hidden' }}>
              {similar.map(s => (
                <div
                  key={s.id}
