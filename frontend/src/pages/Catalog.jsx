  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh', padding: '4rem 2rem' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {/* Filters */}
        <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'nowrap', gap: '1.5rem', marginBottom: '3rem', borderBottom: '1px solid var(--line)', paddingBottom: '1rem' }}>
          <input
            style={{ ...inputStyle, flex: '1 1 0', minWidth: 0 }} placeholder="Rechercher un modèle..."
            value={search} onChange={e => setSearch(e.target.value)}
          />
          <select
            style={{ ...inputStyle, flex: '1 1 0', minWidth: 0, appearance: 'none', cursor: 'pointer' }}
          ...
          <input
            style={{ ...inputStyle, flex: '1 1 0', minWidth: 0 }} placeholder="Budget max (DH)" type="number"
            value={maxBudget} onChange={e => setMaxBudget(e.target.value)}
          />
          <button
            onClick={reset}
            style={{ fontFamily: 'var(--sans)', fontSize: '10px', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--ink-mute)', background: 'none', border: 'none', padding: '0', cursor: 'pointer', transition: 'color 0.2s', whiteSpace: 'nowrap', flexShrink: 0 }}
